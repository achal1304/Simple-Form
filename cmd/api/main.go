...
func main() { // Declare an instance of the config struct.
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", os.Getenv("SIMPLEFORM_DB_DSN"), "PostgreSQL DSN")
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "amittest53@gmail.com", "SMTP username")
